...
function Cart() {
	...
	return (
		<>
			<div
				className="absolute right-8 top-8 p-6 flex items-center justify-center rounded-full text-2xl text-orange-500 bg-white cursor-pointer shadow-lg hover:scale-110 transition-all ease-in-out"
